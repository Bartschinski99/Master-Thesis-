...
// NEMA 17 Stepper Motor settings: 1.46A (OFF;OFF;ON) / 12V / 400 (OFF;ON;ON) 
...
void setup() {
  ...
  delay(25000);            //25s delay between applying adhesive and alignment notification
...
void moveMotorBackward() {
  ...
  if (backwardSteps < 6900) {
    ...
    delay(40000); //40s delay bis neuer Durchgang
