...
// NEMA 17 Stepper Motor settings: 1.46 (ON;ON;OFF) / 12V / 400 (OFF;ON;ON)
...
const unsigned long MOTOR_STEPS = 5000; // Stepper Motor steps after alignment
...
// ============================================================================
//  moveMotor: Move stepper motor 5000 steps
// ============================================================================
...
// ======================================================================
//  moveMotorBackward: Move motor 5000 steps backward to release joint
// ======================================================================
...
void moveMotorBackward() {
  ...
  // 5000 steps backwards
  if (backwardSteps < 5000) {
    digitalWrite(STEP_PIN, HIGH);
    delayMicroseconds(STEP_DELAY_US_INITIAL);
    digitalWrite(STEP_PIN, LOW);
    delayMicroseconds(STEP_DELAY_US_INITIAL);
